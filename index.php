...
<body>
    ...
    <div class="container" style="margin-top: 80px">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="report.php" class="btn btn-md btn-warning" style="margin-bottom: 10px">Cetak</a>
                        <a class="ml-2">Halo, <?= $_SESSION['nama']; ?> !</a>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="report-siswa.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-warning">CETAK</a>
                                        </td>
                                    </tr>
        ...
        <script arc="//cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js"></script>
        <script>
